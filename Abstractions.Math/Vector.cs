...
namespace Abstractions.math
{

    #region Mat4x4 from Microsoft    
    ...
    public struct Matrix4x4 : IEquatable<Matrix4x4>
    {
        ...
        public static Matrix4x4 CreatePerspectiveFieldOfView(float fieldOfView, float aspectRatio, float nearPlaneDistance, float farPlaneDistance)
        {
            ...
            float yScale = 1.0f / (float)System.Math.Tan(fieldOfView * 0.5f);
                ...
                fixed (Vector3* scaleBase = &scale)
                {
                    ...
                    *pVectorBasis[c] = Vector3.Normalize(*pVectorBasis[c]);
                    ...
                    else
                    {
                        ...
                        rotation = Quaternion.CreateFromRotationMatrix((System.Numerics.Matrix4x4)matTemp);
                    }
                }
            }
        ...
        public static explicit operator System.Numerics.Matrix4x4(Abstractions.math.Matrix4x4 mat)
        {
    ...
    public class Vector2d : Vector
    {
        ...
        {
            return new Vector2d(vector1.x * vector2.x, vector2.y * vector1.y);
        }
        public static Vector2d operator +(Vector2d vector1, Vector2d vector2)
        {
            return new Vector2d(vector1.x + vector2.x, vector2.y + vector1.y);
        ...
        public static Vector2d operator *(Vector2d vector1, double d)
        {
            return new Vector2d(vector1.x * d, d * vector1.y);
        }
        public static Vector2d operator +(Vector2d vector1, double d)
        {
            return new Vector2d(vector1.x + d, d + vector1.y);
        ...
        public static Vector2d operator /(Vector2d vector1, double d)
        {
            return new Vector2d(vector1.x / d, vector1.y / d);
        }
        public static Vector2d operator -(Vector2d vector1, double d)
        {
            return new Vector2d(vector1.x - d, vector1.y - d);
    ...
    public class Vector3d : Vector
    {
        ...
        {
            return new Vector3d(vector1.x * vector2.x, vector2.y * vector1.y, vector1.z * vector2.z);
        }
        public static Vector3d operator +(Vector3d vector1, Vector3d vector2)
        {
            return new Vector3d(vector1.x + vector2.x, vector2.y + vector1.y, vector1.z + vector2.z);
        ...
        public static Vector3d operator *(Vector3d vector1, double d)
        {
            return new Vector3d(vector1.x * d, d * vector1.y, vector1.z * d);
        }
        public static Vector3d operator +(Vector3d vector1, double d)
        {
            return new Vector3d(vector1.x + d, d + vector1.y, vector1.z + d);
        ...
        public static Vector3d operator -(Vector3d vector1, double d)
        {
            return new Vector3d(vector1.x - d, vector1.y - d, vector1.z - d);
        }
    }
    public class Vector4d : Vector
    {
        ...
        {
            return new Vector4d(vector1.x * vector2.x, vector2.y * vector1.y, vector1.z * vector2.z, vector1.w * vector2.w);
        }
        public static Vector4d operator +(Vector4d vector1, Vector4d vector2)
        {
            return new Vector4d(vector1.x + vector2.x, vector2.y + vector1.y, vector1.z + vector2.z, vector1.w + vector2.w);
        ...
        public static Vector4d operator *(Vector4d vector1, double d)
        {
            return new Vector4d(vector1.x * d, d * vector1.y, vector1.z * d, vector1.w * d);
        }
        public static Vector4d operator +(Vector4d vector1, double d)
        {
            return new Vector4d(vector1.x + d, d + vector1.y, vector1.z + d, vector1.w + d);
        ...
        public static Vector4d operator -(Vector4d vector1, double d)
        {
            return new Vector4d(vector1.x - d, vector1.y - d, vector1.z - d, vector1.w - d);
        }
    }
}
